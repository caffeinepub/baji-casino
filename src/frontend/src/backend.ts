...
export class Backend implements backendInterface {
    ...
    async addChips(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addChips(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentHistory(): Promise<Array<GameResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordGameRound(arg0: string, arg1: bigint, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async toggleFavoriteGame(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleFavoriteGame(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
